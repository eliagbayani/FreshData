...
<table id="<?php echo $table_id ?>" class="display" cellspacing="0" width="100%">
    <thead>
        <tr>
            ...
            <?php if(in_array($view_type, array("public", "admin", "delRecs", "manRecs"))) echo "<th>Training materials</th>" ?>
            <?php if(in_array($view_type, array("scistarter"))) echo "<th>SciStarter Project ID</th>" ?>

            <?php if(in_array($view_type, array("public", "admin", "delRecs", "manRecs"))) echo "<th>Contact</th>" ?>
        ...
        <?php foreach($rows as $r)
        {
            ?>
                <tr>
                    ...
                    <?php if(in_array($view_type, array("public", "admin", "delRecs", "manRecs"))) echo "<td>".$rek['Training_materials']."</td>" ?>
                    <?php if(in_array($view_type, array("scistarter"))) echo "<td>".self::get_field_value($r['uuid'], "ProjectID", "scistarter")."</td>" ?>

                    <?php if(in_array($view_type, array("public", "admin", "delRecs", "manRecs"))) echo "<td>".$rek['Contact']."</td>" ?>
...
if(in_array($view_type, array("admin", "delRecs", "manRecs")))
{
    ?>
