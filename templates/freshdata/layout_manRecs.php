<div id="tabs_main">
    <ul>
        ...
        <li><a                          href="#tabs_main-9">Admin: Manually-added Records</a></li>
...
<?php 
    ...
    if($params['monitorAPI'] == 0) $admin_unhooked = "http://" . $_SERVER['SERVER_NAME'] . "/FreshData/index.php?view_type=manRecs&monitorAPI=1";
    else                           $admin_unhooked = "http://" . $_SERVER['SERVER_NAME'] . "/FreshData/index.php?view_type=manRecs&monitorAPI=0";
?>
<script>
