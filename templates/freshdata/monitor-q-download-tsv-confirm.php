...
//worked on script
$cmd = WGET_PATH.' --tries=5 -O '.$params['destination'].' "'.$params['url'].'"'; //working well with shell_exec()
$cmd = WGET_PATH.' --tries=5 -O '.$params['destination'].' "'.$params['url'].'"';
$cmd .= " 2>&1";
...
else
{
    ...
    else
    {
        ...
        echo "<br><a href='".$params['search_url']."'>Search in Effechecka</a><br><br>";
    }
}
?>
